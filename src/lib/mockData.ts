...
export const initialBrands: BrandDealer[] = [
  ...
  },
  {
    slug: "adata",
    brandName: "ADATA",
    dealerName: "AL-NABAA — الوكيل المعتمد لـ ADATA في العراق",
    website: "https://www.adata.com/",
    contactPhones: ["6543", "+9647748025119"],
    cities: ["بغداد", "بابل", "الموصل"],
    coverage: "فروع AL-NABAA الحالية لبراند ADATA تشمل Baghdad HQ وMansoor وBabil وMosul، مع توفر منتجات التخزين والذاكرة وإكسسوارات الطاقة.",
    verificationStatus: "verified",
    notes: "تم الربط اعتماداً على صفحات AL-NABAA الرسمية للبراندات والفروع، مع مطابقة الفروع عبر Google Places.",
